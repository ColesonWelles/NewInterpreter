...
func testIntegerObject(t *testing.T, obj object.Object, expected int64) bool {
	...
	if !ok {
		t.Errorf("ojbect is not Integer. got=%T (%+v)", obj, obj)
		return false
	}
...
func testBooleanObject(t *testing.T, obj object.Object, expected bool) bool {
	...
	if !ok {
		t.Errorf("ojbect is not Boolean. got=%T (%+v)", obj, obj)
		return false
	}
...
func testNullObject(t *testing.T, obj object.Object) bool {
	if obj != NULL {
		t.Errorf("object is nto NULL. got=%T (%+v)", obj, obj)
		return false
	}
	return true
}
...
func TestHashLiterals(t *testing.T) {
	...
	for expectedKey, exexpectedValue := range expected {
		pair, ok := result.Pairs[expectedKey]
		if !ok {
			t.Errorf("no pair for given key in Pairs")
		}

		testIntegerObject(t, pair.Value, exexpectedValue)
	}
}
